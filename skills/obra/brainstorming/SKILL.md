...
Use this flow when you are a delegated sub-agent executing mothership's research phase. This is a constrained, autonomous subset of the full brainstorming process.

1. **Explore project context** — Read relevant files, docs, recent commits. Map the current state of the codebase related to the task.
2. **Assess scope** — If the task spans multiple independent subsystems, flag decomposition needs. Recommend which piece to tackle first.
3. **Clarify from context** — Work with the research issue/task as given. Do NOT ask iterative questions. Note ambiguities as open questions in your output.
