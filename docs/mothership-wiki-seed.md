...
- `/api/...` — _describe your API structure here_
- `/admin/...` — _describe admin routes here_

## Component Inventory

_(List key UI components and their locations here.)_

## Query Keys

_(Document React Query / TanStack Query key conventions here.)_

## Permissions

_(Document permission types and roles here.)_

## Architecture Decisions

_(Reference ADRs or list key decisions here.)_
